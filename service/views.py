...
class AccountStatement(ServiceCustomMixin):
    template_name = 'user/role/user/service/account_statement.html'
...
class GiftAgreement(ServiceCustomMixin):
    template_name = 'user/role/user/service/gift_agreement.html'
...
class InheritanceAgreement(ServiceCustomMixin):
    template_name = 'user/role/user/service/inheritance_agreement.html'
...
class ReplaceTp(ServiceCustomMixin):
    template_name = 'user/role/user/service/replace_tp.html'
...
class ReplaceNumberAndTp(ServiceCustomMixin):
    template_name = 'user/role/user/service/replace_number_and_tp.html'
