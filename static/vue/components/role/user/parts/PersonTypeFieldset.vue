    ...
    <div>
        <fieldset>
            ...
            <form @keypress.enter.prevent="!isComplete ? next() : ''">
                <div>
                    <div class="row mb-3">
                        <label class="col-form-label not_copy text-start label_required">Shaxs turini
                            tanlang</label>
                        <div class="col-12">
...
module.exports = {
    ...
    props: ['complete', 'user', 'person_type', 'organization'],
    computed: {
    ...
    components: {
        'OrganizationSelect': httpVueLoader('/static/vue/components/role/user/UI/OrganizationSelect.vue'),
        'OrganizationModal': httpVueLoader('/static/vue/components/role/user/UI/OrganizationModal.vue'),
    },
    created() {
