    ...
    <div>
        <fieldset ref="car_fieldset">
            ...
            <form @keypress.enter.prevent="!isComplete ? sendCarForm() : ''">
                ...
                <div class="row mb-3"
                     v-if="hideDiv(carForm.is_auction, carForm.is_another_car)">
                    <label
                        class="not_copy col-12 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-form-label text-start label_required"
                ...
                <div class="row mb-3"
                     v-if="hideDiv(carForm.is_auction, carForm.is_saved_number)">
                    <label
                        class="not_copy col-12 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-form-label text-start label_required"
                ...
                <div class="row mb-3"
                     v-if="hideDiv(carForm.is_another_car, carForm.is_saved_number)">
                    <label
                        class="not_copy col-12 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-form-label text-start label_required"
    ...
    methods: {
        ...
        async sendCarForm() {
            ...
            if (!this.$v.carForm.$error) {
                ...
                try {
                    this.application = await axios.post("/api/v1/application/create_replace_number_and_tp/", formData)
                        .then((res) => {
                            console.log(res)
                            if (res.status === 201) {
